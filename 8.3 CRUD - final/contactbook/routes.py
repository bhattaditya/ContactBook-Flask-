...
#     contacts = Contact.query.filter_by(creator=current_user, email=email)
#     if contacts.count() > 0:
#         return render_template('home.html', contacts=contacts, title='Contacts',new_heading = 'Listing Contacts')
#     else:
#         return render_template('home.html',title='No contact', new_heading='No contact found for searched email')


@app.route('/home/search_contact',methods=['POST'])
def search_contact():
